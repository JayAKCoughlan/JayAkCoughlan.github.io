...
*	Programming Languages - PHP, Javascript, C#, Java, C, C++, HTML + CSS
*	Game Engines - Unity3D 3.0 & 5.0
*   CI Tools - Jira, Github
...
*	Technical Tools - Visual Studio Code, Visual Studio, Android Studio, DirectX 9
...
*	Communicates expertly across different departments

*****

## ***Work Experience***

#### **Fenris Publishing -** *Remote (May 2022 - Current)*
**Gameplay Developer**
-   Built using Unity3D 
-   Built, developed, and tested gameplay mechanics (including player controls, enemy AI, environment, and menu UI) as a part of a four-person team
-   Managed development tasks alongside full-time work
