...
Currently, Jay is working at Checkfront as the lead for the development team as a **Jr Software Developer**, though he's been working in Checkfront's development flow for many years. In this role he investigates and resolves challenging bugs, develops and implements plans for new features, and helps to co-ordinate and document new processes. He uses his skills in the **Support** and **Quality Assurance** teams to help develop robust, performant code that delight customers worldwide.
